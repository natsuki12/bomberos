      ...
      <table class="table table-responsive p-0 text-center table-striped table-bordered col-12 " style="box-shadow: 0px 5px 10px -2px rgba(0,0,0,0.2);">
        ...
        <tbody id="tbody">
            <tr>
              ...
              <td><a class="croquis text-primary" data-toggle="modal" data-target="#croquis" id="<?php //echo $pescador->cedula ?>" style="cursor: pointer;">Ver</a></td>
              <td><?php //echo $pescador->correo ?>a</td>
              <td><?php //echo $pescador->telefono1 ?>a</td>
              <td><?php //echo $pescador->telefono2 ?>a</td>
              <td><?php //echo $pescador->correo ?>a</td><td><a class="croquis text-primary" id="<?php //echo $pescador->cedula ?>" style="cursor: pointer;">Ver</a></td>
              <!-- ABRE UN WINDOW.OPEN CON EL CERTIFICADO, SI ESTA VENCIDA LA SOLICITUD O NO HA PAGADO IMPRIME OTRO TD QUE DIGA ALGO -->
              <td><a class="text-primary"data-toggle="modal" data-target="#pagos" id="<?php //echo $pescador->cedula ?>" style="cursor: pointer;">Enviar</a></td>
              <td><a class="text-primary" href="m_solicitud.php?codigo=<?php //echo $pescador->cedula ?>">Enviarr</a></td>
            </tr>           
        </tbody>
      </table>
      <div class="row justify-content-between">
...
<!-- MODAL PARA CUANDO QUIERA VER AL DETALLE LA INFORMACION DE CROQUIS -->
...
<!-- MODAL PARA CUANDO QUIERA VER AL DETALLE LA INFORMACION DE CROQUIS -->
<div class="modal fade" id="pagos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="height: auto;">
            <div class="modal-header">
                <h5 class="modal-title" id="redes_titulo">Registro de Pagos<br></h5>
                <button type="button" class="close r-cerrar" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
              ...
              <!-- SECCION REFERENTE A LOS PAGOS DE INSPECCION -->

              <div id="inspeccion_pago" class="d-none"> <!-- SI YA PAGO SALE ESTO -->
                <div class="form-group">
                    <label>Referencía de Pago:</label>
                    <label class="form-control" id="referencia_pago">X Referencia</label>
                </div>
                <div class="form-group">
                    <label>Monto Pagado:</label>
                    <label class="form-control" id="referencia_pago">X Monto</label>
                </div>
                <div class="form-group">
                    <label>Inspector Seleccionado:</label>
                    <label class="form-control" id="referencia_pago">X Inspector</label>
                </div>
              </div>
              <div id="inspeccion_nopago"> <!-- SI NO LO HA PAGADO SALE ESTO -->
                <h6 class="text-center pb-2 col-12" style="border-bottom: 2px solid">Pagos Referentes a la Inspección</h6>
                <div class="form-group text-justify col-12 row justify-content-center m-auto">
                  <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">  
                    <label class="text-muted" style="font-size: 1.2em">Referencía de Pago:</label>
                    <input type="text" class="form-control" id="referencia1" name="referencia1" placeholder="Ingrese la Referencía del Pago">
                  </div>
                  <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">
                    <label class="text-muted" style="font-size: 1.2em">Monto del Pago:</label>
                    <input type="text" class="form-control" id="monto1" name="monto1" placeholder="Ingresar Monto"> 
                  </div>
                  <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">  
                    <label class="text-muted" style="font-size: 1.2em">Inspector :</label>
                    <select class="form-control" id="inspector_pago" name="inspector_pago">
                      <option value="">Seleccione un Inspector:</option>
                      <option value="xxxxxx">CARGA DE LA BD</option>
                      <option value="xxxxxx">CARGA DE LA BD</option>
                    </select>
                  </div>
                </div>
              ...
              <!-- PAGOS REFERENTES A LA ENTREGA DEL ULTIMO CERTIFICADO O DOCUMENTO -->

              <div id="certificado_pago" class="d-none"> <!-- SI YA PAGO SALE ESTO -->
                <div class="form-group">
                    <label>Referencía de Pago:</label>
                    <label class="form-control" id="referencia_pago">X Referencia</label>
                </div>
              ...
              <div id="certificado_nopago" class="mt-4"> <!-- SI NO LO HA PAGADO SALE ESTO -->
                <h6 class="text-center pb-2 col-12" style="border-bottom: 2px solid">Pagos Referentes al Certificado Final</h6>
                <div class="form-group text-justify col-12 row justify-content-center m-auto">
                  <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">  
                    <label class="text-muted" style="font-size: 1.2em">Referencía de Pago:</label>
                    <input type="text" class="form-control" id="referencia2" name="referencia2" placeholder="Ingrese la Referencía del Pago">
                  </div>
                  <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">
                    <label class="text-muted" style="font-size: 1.2em">Monto del Pago:</label>
                    <input type="text" class="form-control" id="monto2" name="monto2" placeholder="Ingresar Monto"> 
                  </div>
                </div>
              </div>
            </div>
