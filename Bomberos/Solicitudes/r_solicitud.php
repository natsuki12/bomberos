  ...
  <script type="text/javascript">
	...
	<div class="row text-center mt-2">
	    <div class="col-sm-10 col-12 text-center m-auto">
	        ...
	        <h4 class="text-center mt-3">REGISTRO DE SOLICITUD</h4>
	    </div>
		...
		<div class="col-md-8 col-sm-11 col-12 mx-auto shadow-sm my-3 py-2 rounded" style="box-shadow: 0px 5px 10px -2px rgba(0,0,0,0.2); background-color: white">
			<form class="m-auto col-12 justify-content-center" id="solicitud" action="censo.php" method="post">
			...
			<!-- FIN INFORMACION DE CONTACTO -->
			  ...
			  <div class="col-12 mt-3 mb-5"><img src="../Imagenes/franja.jpg" class="img-fluid"></div>
			    ...
			    <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">
			  	...
			  	<div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">	
				    ...
				    <div class="col-12 text-center">
					    <label class="radio-inline mr-3"><input type="radio" id="personal" name="optradio" value="Personal" checked>Personal</label>
						<label class="radio-inline"><input type="radio" id="juridico" name="optradio" value="Juridica">Juridica</label>
					</div>
			    </div>
			    <div class="col-lg-6 col-md-10 col-sm-6 col-12  mb-3">	
