        ...
        <div class="col-lg-12 col-md-12 m-auto py-3">
          <div class="row text-center">
            ...
            <div class='col-12 text-center'>
              <h1 class="font-weight-light fuente">Bienvenido <?php if($u_nivel==1) echo "Administrador"; else echo "Operador";?></h1>
              <p class='font-weight-light text-dark fuente2'><span class='text-primary text-center'>Unidad de Prevención de Siniestros del Cuerpo de Bomberos<br>Estado Nueva Esparta</span>
