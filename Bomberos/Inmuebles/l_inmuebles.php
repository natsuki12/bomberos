...
?>
  ...
  <style type="text/css">
    ...
    <div class="col-lg-10 mx-auto">
      ...
      <h4 class="text-center mt-4">HISTORIAL DE INMUEBLES REGISTRADOS</h4>
    </div>
    <div class="col-md-8 col-sm-11 col-12 mx-auto shadow-sm my-3 py-2 rounded" style="box-shadow: 0px 5px 10px -2px rgba(0,0,0,0.2); background-color: white">
        <h5 class="text-primary mt-4">Historial de Listado de Inmuebles:</h5>
